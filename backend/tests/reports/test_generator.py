...
@pytest.mark.asyncio
async def test_generate_detection_report_with_filters(
    report_generator, mock_db_session, mock_detection
):
    ...
    start_date = datetime(2024, 3, 1)
    end_date = datetime(2024, 3, 31)
    filters = {"station": "Test Station", "artist": "Test Artist"}
...
@pytest.mark.asyncio
async def test_generate_station_report(
    report_generator, mock_db_session, mock_station, mock_detection
):
