...
def test_generate_detections_success(mock_sessionmaker, mock_get_db_url, mock_create_engine, mock_session, mock_track, mock_station):
...
@patch('backend.analytics.generate_detections.get_database_url')
@patch('backend.analytics.generate_detections.sessionmaker')
def test_generate_detections_no_tracks(mock_sessionmaker, mock_get_db_url, mock_create_engine, mock_session):
...
@patch('backend.analytics.generate_detections.get_database_url')
@patch('backend.analytics.generate_detections.sessionmaker')
def test_generate_detections_no_stations(mock_sessionmaker, mock_get_db_url, mock_create_engine, mock_session, mock_track):
...
@patch('backend.analytics.generate_detections.get_database_url')
@patch('backend.analytics.generate_detections.sessionmaker')
def test_generate_detections_session_error(mock_sessionmaker, mock_get_db_url, mock_create_engine, mock_session, mock_track, mock_station):
