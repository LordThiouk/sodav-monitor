...
def test_create_test_report_success(
    mock_get_data, mock_session_local, mock_db, mock_user, mock_report, mock_summary_data
):
...
@patch("backend.analytics.generate_test_report.SessionLocal")
@patch("backend.analytics.generate_test_report.get_summary_data")
def test_create_test_report_file_error(
    mock_get_data, mock_session_local, mock_db, mock_user, mock_summary_data
):
