...
from backend.utils.musicbrainz_recognizer import MusicBrainzRecognizer
...
@pytest.mark.asyncio
async def test_recognize_from_audio_data_local_success(mock_settings, mock_db_session, mock_local_detector, mock_audio_data):
...
@pytest.mark.asyncio
async def test_recognize_from_audio_data_acoustid_success(mock_settings, mock_db_session, mock_local_detector, mock_external_handler, mock_audio_data):
...
@pytest.mark.asyncio
async def test_recognize_from_audio_data_audd_success(mock_settings, mock_db_session, mock_local_detector, mock_external_handler, mock_audio_data):
...
@pytest.mark.asyncio
async def test_recognize_from_audio_data_all_services_fail(mock_settings, mock_db_session, mock_local_detector, mock_external_handler, mock_audio_data):
...
@pytest.mark.asyncio
async def test_recognize_from_audio_data_low_confidence_results(mock_settings, mock_db_session, mock_local_detector, mock_external_handler, mock_audio_data):
...
@pytest.mark.asyncio
async def test_service_error_handling(mock_settings, mock_db_session, mock_local_detector, mock_external_handler, mock_audio_data):
    ...
    with patch('backend.utils.musicbrainz_recognizer.Settings', return_value=mock_settings):
        ...
        with patch.object(recognizer, '_analyze_audio_features') as mock_analyze:
            ...
            mock_external_handler.recognize_with_musicbrainz.side_effect = Exception("AcoustID error")
