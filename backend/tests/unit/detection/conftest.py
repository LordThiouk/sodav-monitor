...
def mock_config():
    ...
    return {
        "audio": {"sample_rate": 44100, "channels": 2, "chunk_size": 4096, "buffer_size": 16384},
        "detection": {"confidence_threshold": 0.8, "min_duration": 1.0, "max_silence": 0.5},
        "api": {"musicbrainz_api_key": "test_mb_key", "audd_api_key": "test_audd_key"},
    }
