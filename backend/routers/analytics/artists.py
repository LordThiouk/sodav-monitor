...
async def get_artist_stats(
    ...
    try:
        ...
        if artist_id:
            ...
            recent_detections = db.query(TrackDetection)\
                ...
                "recent_detections": [
                    {
                        ...
                        "play_duration": str(detection.play_duration) if detection.play_duration else None
            ...
            return [
                {
                    ...
                    "stats": {
                        ...
                        "total_play_time": str(artist.stats.total_play_time) if artist.stats and artist.stats.total_play_time else "0:00:00",
                        "last_detected": artist.stats.last_detected.isoformat() if artist.stats and artist.stats.last_detected else None
                    }
