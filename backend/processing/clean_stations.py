...
def clean_stations():
    ...
    try:
        ...
        deleted_count = db.query(RadioStation).filter(RadioStation.country != "Senegal").delete()
        ...
        senegal_count = db.query(RadioStation).filter(RadioStation.country == "Senegal").count()
