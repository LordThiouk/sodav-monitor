...
async def check_stream_availability(stream_url: str, timeout: int = 10) -> Dict[str, bool]:
    """
...
async def get_stream_metadata(stream_url: str, timeout: int = 10) -> Optional[Dict[str, str]]:
    """
