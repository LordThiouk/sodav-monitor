        ...
        try:
            ...
            class LogManager:
                    ...
                    if not self.root_logger.handlers:
                        ...
                        try:
                            ...
                            general_handler = RotatingFileHandler(
                                general_log_path, maxBytes=10 * 1024 * 1024, backupCount=5  # 10 MB
                            )
                            ...
                            error_handler = RotatingFileHandler(
                                error_log_path, maxBytes=10 * 1024 * 1024, backupCount=5  # 10 MB
                            )
                ...
                def get_logger(self, name: str) -> logging.Logger:
                    ...
                    full_name = (
                        f"sodav_monitor.{name}" if not name.startswith("sodav_monitor") else name
                    )
