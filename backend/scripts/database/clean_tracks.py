    ...
    try:
        ...
        try:
            ...
            log_with_category(
                ...
                "DATABASE",
                "info",
                f"Found {track_count} tracks, {detection_count} detections, {stats_count} track stats, and {station_stats_count} station track stats",
            )
            ...
            log_with_category(
                ...
                "DATABASE",
                "info",
                "Successfully cleaned tracks and detections from database",
            )
...
if __name__ == "__main__":
    ...
    confirm = input(
        "Êtes-vous sûr de vouloir supprimer TOUTES les pistes et détections de la base de données ? (oui/non): "
    )
