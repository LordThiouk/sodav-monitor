...
from backend.models.models import (
    User, Report, ReportSubscription, RadioStation, Artist, Track,
    TrackDetection, DetectionHourly, ArtistStats, TrackStats, AnalyticsData,
    DetectionDaily, DetectionMonthly, StationStats, TrackDaily, TrackMonthly,
    ArtistDaily, ArtistMonthly, StationTrackStats, StationHealth, StationStatusHistory
)
...
def clean_database():
    ...
    try:
        ...
        try:
            ...
            tables = [
                "users", "reports", "report_subscriptions", "radio_stations", 
                "artists", "tracks", "track_detections", "detection_hourly", 
                "artist_stats", "track_stats", "analytics_data", "detection_daily", 
                "detection_monthly", "station_stats", "track_daily", "track_monthly", 
                "artist_daily", "artist_monthly", "station_track_stats", 
                "station_health", "station_status_history"
            ]
