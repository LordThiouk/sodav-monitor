...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", type=str, default=os.path.join("backend", "tests", "data", "audio"),
                        help="Output directory for test audio files")
    parser.add_argument("--filename", type=str, default="test_audio.mp3",
                        help="Filename for the test audio file")
    parser.add_argument("--format", type=str, default="mp3", choices=["mp3", "wav"],
                        help="Format of the test audio file")
    parser.add_argument("--duration", type=float, default=5.0,
                        help="Duration of the test audio file in seconds")
