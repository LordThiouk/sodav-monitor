...
def upgrade():
    ...
    op.add_column('reports', sa.Column('status', sa.String(), nullable=False, server_default='pending'))
    ...
    op.add_column('report_subscriptions', sa.Column('include_graphs', sa.Boolean(), nullable=True, server_default='true'))
    op.add_column('report_subscriptions', sa.Column('language', sa.String(), nullable=True, server_default='fr'))
    op.add_column('report_subscriptions', sa.Column('active', sa.Boolean(), nullable=True, server_default='true'))
