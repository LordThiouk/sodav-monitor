...
def upgrade():
    ...
    op.create_index('idx_track_detections_composite', 'track_detections', ['station_id', 'track_id', 'detected_at'])
    ...
    op.create_index('idx_station_track_stats_composite', 'station_track_stats', ['station_id', 'track_id'])
