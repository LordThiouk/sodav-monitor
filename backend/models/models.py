...
class User(Base):
    ...
    subscriptions = relationship(
        "ReportSubscription", back_populates="user", foreign_keys="ReportSubscription.user_id"
    )
    created_subscriptions = relationship(
        "ReportSubscription", back_populates="creator", foreign_keys="ReportSubscription.created_by"
    )
...
class ReportSubscription(Base):
    ...
    creator = relationship(
        "User", back_populates="created_subscriptions", foreign_keys=[created_by]
    )
...
class Artist(Base):
    ...
    stats = relationship(
        "ArtistStats", back_populates="artist", uselist=False, cascade="all, delete-orphan"
    )
    daily_stats = relationship("ArtistDaily", back_populates="artist", cascade="all, delete-orphan")
    monthly_stats = relationship(
        "ArtistMonthly", back_populates="artist", cascade="all, delete-orphan"
    )
...
Index(
    "idx_tracks_title_artist_id", Track.title, Track.artist_id
)  # Combined index for title and artist_id
