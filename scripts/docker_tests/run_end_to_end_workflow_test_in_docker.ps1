...
# Script to run the end-to-end workflow test in the existing Docker development environment
Write-Host "SODAV Monitor - Running End-to-End Workflow Test in Docker" -ForegroundColor Green
...
# Execute the end-to-end workflow test in the backend container
