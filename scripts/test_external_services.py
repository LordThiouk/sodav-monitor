...
def main():
    ...
    if system_deps and external_services:
        ...
        print("⚠️  System dependencies are correctly installed, but external services are not configured correctly.")
        print("   Please check your API keys and internet connection.")
        return 1
    elif not system_deps:
        print("❌ System dependencies are not correctly installed.")
        print("   Please follow the setup instructions in docs/tests/production_test_environment.md")
        return 2
